...
async def emit_context_view(
    ...
    *,
    ...
    context, and awaits the tap. A tap is contracted to return promptly; we also
    swallow and log any exception so an observer can never disturb the governance
    hot path.
    """
    if tap is None:
        return
